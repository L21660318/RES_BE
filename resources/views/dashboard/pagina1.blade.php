...
<body>
    ...
    <main class="main-content">
        <div class="profile-arc">
            ...
            <button type="button" class="btn btn-primary btn-upload" data-bs-toggle="modal" data-bs-target="#addProjectModal">
                Subir Archivo
            </button>
        </div>
    </main>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('proyectos.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            <label for="projectImage" class="form-label">Subir Imagen</label>
                            <input type="file" class="form-control" id="imagen" name="imagen" accept="image/*" required>
                        </div>
                        <div class="mb-3">
                            <label for="projectPDF" class="form-label">Subir Archivo PDF</label>
