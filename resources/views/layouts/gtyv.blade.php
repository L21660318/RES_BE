...
<head>
    ...
    <style>
        ...
        /* Mejorar el estilo de las tarjetas */
        .projects {
            display: grid;
        ...
        .card:hover {
            transform: translateY(-10px); /* Sutil elevación al pasar el ratón */
            box-shadow: 0px 15px 30px rgba(0, 0, 0, 0.2); /* Más sombra al hacer hover */
        }
        ...
        .card .btn:hover {
            background-color: #1d64d3; /* Cambio a un azul más oscuro */
            transform: translateY(-3px); /* Sutil elevación al hacer hover */
        }

        /* Fondo de la tarjeta con un degradado sutil */
        .card .background {
            position: absolute;
            top: 0;
            left: 0;
